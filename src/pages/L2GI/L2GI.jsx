...
const L2GI = () => {
    ...
    useEffect(() => {
        const savedSearchTerm = localStorage.getItem('l2GI_searchTerm');
        const savedSortOption = localStorage.getItem('l2GI_sortOption');
    ...
    useEffect(() => {
        localStorage.setItem('l2GI_searchTerm', searchTerm);
    }, [searchTerm]);

    useEffect(() => {
        localStorage.setItem('l2GI_sortOption', sortOption);
    }, [sortOption]);
    ...
    const handleClearFilters = () => {
        ...
        localStorage.removeItem('l2GI_searchTerm');
        localStorage.removeItem('l2GI_sortOption');
        setCurrentPage(1);
    ...
    if (error) {
        return (
            <div className="space-y-6">
                <PageHeader 
                    title="L2 GI"
                    subtitle="Gestion des étudiants en Licence 2 Génie Informatique"
                />
    ...
    return (
        <>
                    ...
                    <div className="bg-slate-900/60 backdrop-blur-sm rounded-xl border border-blue-400/20 p-4">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-white font-medium">Liste des étudiants L2 GI</h3>
                                    <p className="text-blue-200/60 text-sm">
                                        {searchTerm ? (
                                            ...
                                            `${etudiants.length} étudiant${etudiants.length !== 1 ? 's' : ''} en L2 GI`
                                        )}
                                    </p>
                                </div>
                            </div>
                        ...
                        {searchTerm ? (
                            ...
                            <>
                                ...
                                <motion.p 
                                    ...
                                    transition={{ delay: 0.3 }}
                                >
                                    Aucun étudiant n'a été importé en L2 GI. Importez un fichier Excel pour commencer.
                                </motion.p>
            ...
            <ImportEtudiantModal
                ...
                niveau="L2"
                filiere="GI"
                titre="Importer les étudiants L2 GI"
            />
